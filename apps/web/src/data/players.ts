...
export const players: Player[] = [
  // ═══ ARGENTINA 🇦🇷 ═══
  { id: 'ar-1', name: 'Lionel Messi', country: 'Argentina', countryCode: 'AR', countryFlag: '🇦🇷', team: 'Inter Miami', position: 'Forward', number: 10, rating: 99, teamColors: ['#75AADB', '#FFFFFF'] },
  { id: 'ar-2', name: 'Ángel Di María', country: 'Argentina', countryCode: 'AR', countryFlag: '🇦🇷', team: 'Benfica', position: 'Forward', number: 11, rating: 88, teamColors: ['#75AADB', '#FFFFFF'] },
  { id: 'ar-3', name: 'Julián Álvarez', country: 'Argentina', countryCode: 'AR', countryFlag: '🇦🇷', team: 'Atlético Madrid', position: 'Forward', number: 9, rating: 90, teamColors: ['#75AADB', '#FFFFFF'] },
  ...
  // ═══ BRAZIL 🇧🇷 ═══
  { id: 'br-1', name: 'Vinícius Jr', country: 'Brazil', countryCode: 'BR', countryFlag: '🇧🇷', team: 'Real Madrid', position: 'Forward', number: 7, rating: 96, teamColors: ['#009C3B', '#FFDF00'] },
  { id: 'br-2', name: 'Rodrygo', country: 'Brazil', countryCode: 'BR', countryFlag: '🇧🇷', team: 'Real Madrid', position: 'Forward', number: 11, rating: 89, teamColors: ['#009C3B', '#FFDF00'] },
  ...
  // ═══ FRANCE 🇫🇷 ═══
  { id: 'fr-1', name: 'Kylian Mbappé', country: 'France', countryCode: 'FR', countryFlag: '🇫🇷', team: 'Real Madrid', position: 'Forward', number: 10, rating: 97, teamColors: ['#002395', '#FFFFFF'] },
  { id: 'fr-2', name: 'Antoine Griezmann', country: 'France', countryCode: 'FR', countryFlag: '🇫🇷', team: 'Atlético Madrid', position: 'Forward', number: 7, rating: 89, teamColors: ['#002395', '#FFFFFF'] },
  ...
  // ═══ GERMANY 🇩🇪 ═══
  { id: 'de-1', name: 'Jamal Musiala', country: 'Germany', countryCode: 'DE', countryFlag: '🇩🇪', team: 'Bayern Munich', position: 'Midfielder', number: 10, rating: 92, teamColors: ['#000000', '#FFFFFF'] },
  { id: 'de-2', name: 'Florian Wirtz', country: 'Germany', countryCode: 'DE', countryFlag: '🇩🇪', team: 'Bayer Leverkusen', position: 'Midfielder', number: 17, rating: 91, teamColors: ['#000000', '#FFFFFF'] },
  ...
  // ═══ SPAIN 🇪🇸 ═══
  { id: 'es-1', name: 'Lamine Yamal', country: 'Spain', countryCode: 'ES', countryFlag: '🇪🇸', team: 'Barcelona', position: 'Forward', number: 19, rating: 93, teamColors: ['#AA151B', '#F1BF00'] },
  ...
  { id: 'es-3', name: 'Rodri', country: 'Spain', countryCode: 'ES', countryFlag: '🇪🇸', team: 'Manchester City', position: 'Midfielder', number: 16, rating: 93, teamColors: ['#AA151B', '#F1BF00'] },
  ...
  // ═══ ENGLAND 🏴󠁧󠁢󠁥󠁮󠁧󠁿 ═══
  { id: 'gb-1', name: 'Jude Bellingham', country: 'England', countryCode: 'GB', countryFlag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team: 'Real Madrid', position: 'Midfielder', number: 10, rating: 95, teamColors: ['#FFFFFF', '#CF081F'] },
  { id: 'gb-2', name: 'Bukayo Saka', country: 'England', countryCode: 'GB', countryFlag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team: 'Arsenal', position: 'Forward', number: 7, rating: 91, teamColors: ['#FFFFFF', '#CF081F'] },
  { id: 'gb-3', name: 'Phil Foden', country: 'England', countryCode: 'GB', countryFlag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team: 'Manchester City', position: 'Midfielder', number: 11, rating: 90, teamColors: ['#FFFFFF', '#CF081F'] },
  ...
  { id: 'gb-5', name: 'Harry Kane', country: 'England', countryCode: 'GB', countryFlag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team: 'Bayern Munich', position: 'Forward', number: 9, rating: 93, teamColors: ['#FFFFFF', '#CF081F'] },

  // ═══ PORTUGAL 🇵🇹 ═══
  { id: 'pt-1', name: 'Cristiano Ronaldo', country: 'Portugal', countryCode: 'PT', countryFlag: '🇵🇹', team: 'Al Nassr', position: 'Forward', number: 7, rating: 95, teamColors: ['#006847', '#FF0000'] },
  { id: 'pt-2', name: 'Bruno Fernandes', country: 'Portugal', countryCode: 'PT', countryFlag: '🇵🇹', team: 'Manchester United', position: 'Midfielder', number: 8, rating: 90, teamColors: ['#006847', '#FF0000'] },
  ...
  { id: 'it-3', name: 'Nicolò Barella', country: 'Italy', countryCode: 'IT', countryFlag: '🇮🇹', team: 'Inter Milan', position: 'Midfielder', number: 23, rating: 89, teamColors: ['#009246', '#0066CC'] },
  ...
  // ═══ NETHERLANDS 🇳🇱 ═══
  { id: 'nl-1', name: 'Virgil van Dijk', country: 'Netherlands', countryCode: 'NL', countryFlag: '🇳🇱', team: 'Liverpool', position: 'Defender', number: 4, rating: 90, teamColors: ['#FF6600', '#FFFFFF'] },
  ...
  { id: 'nl-3', name: 'Xavi Simons', country: 'Netherlands', countryCode: 'NL', countryFlag: '🇳🇱', team: 'RB Leipzig', position: 'Midfielder', number: 10, rating: 87, teamColors: ['#FF6600', '#FFFFFF'] },
  ...
  // ═══ BELGIUM 🇧🇪 ═══
  { id: 'be-1', name: 'Kevin De Bruyne', country: 'Belgium', countryCode: 'BE', countryFlag: '🇧🇪', team: 'Manchester City', position: 'Midfielder', number: 7, rating: 93, teamColors: ['#ED2939', '#FDDA24'] },
  ...
  // ═══ CROATIA 🇭🇷 ═══
  { id: 'hr-1', name: 'Luka Modrić', country: 'Croatia', countryCode: 'HR', countryFlag: '🇭🇷', team: 'Real Madrid', position: 'Midfielder', number: 10, rating: 90, teamColors: ['#FF0000', '#FFFFFF'] },
  ...
  // ═══ USA 🇺🇸 ═══
  { id: 'us-1', name: 'Christian Pulisic', country: 'USA', countryCode: 'US', countryFlag: '🇺🇸', team: 'AC Milan', position: 'Forward', number: 10, rating: 87, teamColors: ['#002868', '#BF0A30'] },
  ...
  // ═══ SOUTH KOREA 🇰🇷 ═══
  { id: 'kr-1', name: 'Son Heung-min', country: 'South Korea', countryCode: 'KR', countryFlag: '🇰🇷', team: 'Tottenham', position: 'Forward', number: 7, rating: 92, teamColors: ['#CD2E3A', '#FFFFFF'] },
  ...
  // ═══ TURKEY 🇹🇷 ═══
  { id: 'tr-1', name: 'Hakan Çalhanoğlu', country: 'Turkey', countryCode: 'TR', countryFlag: '🇹🇷', team: 'Inter Milan', position: 'Midfielder', number: 10, rating: 88, teamColors: ['#E30A17', '#FFFFFF'] },
  { id: 'tr-2', name: 'Kenan Yıldız', country: 'Turkey', countryCode: 'TR', countryFlag: '🇹🇷', team: 'Juventus', position: 'Forward', number: 10, rating: 84, teamColors: ['#E30A17', '#FFFFFF'] },
  { id: 'tr-3', name: 'Arda Güler', country: 'Turkey', countryCode: 'TR', countryFlag: '🇹🇷', team: 'Real Madrid', position: 'Midfielder', number: 15, rating: 85, teamColors: ['#E30A17', '#FFFFFF'] },
  ...
  // ═══ SENEGAL 🇸🇳 ═══
  { id: 'sn-1', name: 'Sadio Mané', country: 'Senegal', countryCode: 'SN', countryFlag: '🇸🇳', team: 'Al Nassr', position: 'Forward', number: 10, rating: 87, teamColors: ['#00853F', '#FDEF42'] },
  ...
  // ═══ NIGERIA 🇳🇬 ═══
  { id: 'ng-1', name: 'Victor Osimhen', country: 'Nigeria', countryCode: 'NG', countryFlag: '🇳🇬', team: 'Napoli', position: 'Forward', number: 9, rating: 90, teamColors: ['#008751', '#FFFFFF'] },
  ...
  { id: 'uy-2', name: 'Federico Valverde', country: 'Uruguay', countryCode: 'UY', countryFlag: '🇺🇾', team: 'Real Madrid', position: 'Midfielder', number: 15, rating: 91, teamColors: ['#001489', '#75AADB'] },
  { id: 'uy-3', name: 'Darwin Núñez', country: 'Uruguay', countryCode: 'UY', countryFlag: '🇺🇾', team: 'Liverpool', position: 'Forward', number: 9, rating: 87, teamColors: ['#001489', '#75AADB'] },
  ...
  { id: 'co-2', name: 'Luis Díaz', country: 'Colombia', countryCode: 'CO', countryFlag: '🇨🇴', team: 'Liverpool', position: 'Forward', number: 7, rating: 87, teamColors: ['#FCD116', '#003893'] },
  ...
  // ═══ MOROCCO 🇲🇦 ═══
  { id: 'ma-1', name: 'Achraf Hakimi', country: 'Morocco', countryCode: 'MA', countryFlag: '🇲🇦', team: 'PSG', position: 'Defender', number: 2, rating: 89, teamColors: ['#C1272D', '#006233'] },
  ...
  // ═══ CANADA 🇨🇦 ═══
  { id: 'ca-1', name: 'Alphonso Davies', country: 'Canada', countryCode: 'CA', countryFlag: '🇨🇦', team: 'Bayern Munich', position: 'Defender', number: 19, rating: 86, teamColors: ['#FF0000', '#FFFFFF'] },
  ...
  // ═══ GHANA 🇬🇭 ═══
  { id: 'gh-1', name: 'Mohammed Kudus', country: 'Ghana', countryCode: 'GH', countryFlag: '🇬🇭', team: 'West Ham', position: 'Midfielder', number: 14, rating: 84, teamColors: ['#006B3F', '#FCD116'] },
  ...
  // ═══ SWITZERLAND 🇨🇭 ═══
  { id: 'ch-1', name: 'Granit Xhaka', country: 'Switzerland', countryCode: 'CH', countryFlag: '🇨🇭', team: 'Bayer Leverkusen', position: 'Midfielder', number: 10, rating: 86, teamColors: ['#FF0000', '#FFFFFF'] },
  ...
  // ═══ SERBIA 🇷🇸 ═══
  { id: 'rs-1', name: 'Dušan Vlahović', country: 'Serbia', countryCode: 'RS', countryFlag: '🇷🇸', team: 'Juventus', position: 'Forward', number: 9, rating: 86, teamColors: ['#C6363C', '#FFFFFF'] },
  ...
  // ═══ POLAND 🇵🇱 ═══
  { id: 'pl-1', name: 'Robert Lewandowski', country: 'Poland', countryCode: 'PL', countryFlag: '🇵🇱', team: 'Barcelona', position: 'Forward', number: 9, rating: 91, teamColors: ['#DC143C', '#FFFFFF'] },
  ...
  { id: 'ec-2', name: 'Moisés Caicedo', country: 'Ecuador', countryCode: 'EC', countryFlag: '🇪🇨', team: 'Chelsea', position: 'Midfielder', number: 25, rating: 85, teamColors: ['#FFD100', '#003DA5'] },
  ...
  // ═══ IRAN 🇮🇷 ═══
  { id: 'ir-1', name: 'Mehdi Taremi', country: 'Iran', countryCode: 'IR', countryFlag: '🇮🇷', team: 'Inter Milan', position: 'Forward', number: 9, rating: 83, teamColors: ['#239F40', '#DA0000'] },
  ...
  // ═══ ALGERIA 🇩🇿 ═══
  { id: 'dz-1', name: 'Riyad Mahrez', country: 'Algeria', countryCode: 'DZ', countryFlag: '🇩🇿', team: 'Al Ahli', position: 'Forward', number: 7, rating: 84, teamColors: ['#006233', '#FFFFFF'] },
  ...
  // ═══ SWEDEN 🇸🇪 ═══
  { id: 'se-1', name: 'Alexander Isak', country: 'Sweden', countryCode: 'SE', countryFlag: '🇸🇪', team: 'Newcastle', position: 'Forward', number: 14, rating: 86, teamColors: ['#006AA7', '#FECC00'] },
  ...
  { id: 'se-3', name: 'Viktor Gyökeres', country: 'Sweden', countryCode: 'SE', countryFlag: '🇸🇪', team: 'Sporting CP', position: 'Forward', number: 9, rating: 86, teamColors: ['#006AA7', '#FECC00'] },

  // ═══ NORWAY 🇳🇴 ═══
  { id: 'no-1', name: 'Erling Haaland', country: 'Norway', countryCode: 'NO', countryFlag: '🇳🇴', team: 'Manchester City', position: 'Forward', number: 9, rating: 96, teamColors: ['#BA0C2F', '#00205B'] },
  { id: 'no-2', name: 'Martin Ødegaard', country: 'Norway', countryCode: 'NO', countryFlag: '🇳🇴', team: 'Arsenal', position: 'Midfielder', number: 8, rating: 90, teamColors: ['#BA0C2F', '#00205B'] },
  ...
  // ═══ EGYPT 🇪🇬 ═══
  { id: 'eg-1', name: 'Mohamed Salah', country: 'Egypt', countryCode: 'EG', countryFlag: '🇪🇬', team: 'Liverpool', position: 'Forward', number: 11, rating: 93, teamColors: ['#CE1126', '#FFFFFF'] },
